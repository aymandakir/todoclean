    ...
    <div className="flex min-h-screen items-start justify-center bg-background pt-24 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="flex gap-2 mb-6">
          ...
          <button
            onClick={addTodo}
            className="rounded-lg bg-primary px-5 py-2 text-primary-foreground font-semibold shadow-lg shadow-primary/30 hover:shadow-xl hover:shadow-primary/40 hover:scale-105 active:scale-95 transition-all duration-200"
          >
            Add
          </button>
        </div>
