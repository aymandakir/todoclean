    ...
    <div className="flex min-h-screen items-start justify-center bg-background pt-24 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="flex gap-2 mb-6">
          ...
          <button
            onClick={addTodo}
            className="rounded-lg bg-primary px-4 py-2 text-primary-foreground font-medium hover:opacity-90 transition-opacity"
          >
            Add
          </button>
        </div>
        ...
        <ul className="space-y-2">
          ...
          {todos.map(todo => (
            ...
            >
              ...
              />
              <span className={`flex-1 text-foreground ${todo.done ? "line-through text-muted-foreground" : ""}`}>
                {todo.text}
              </span>
              <button
